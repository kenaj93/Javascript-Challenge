...
// YOUR CODE HERE! reference assignments 14.3.8, 14.3.9, 14.3.3
...
function autoPopulate(tableData) {
    ...
    // Use d3 to  populate tableData by creating table rows and cells.

tableData.forEach((aliens) => {
    // Creating table rows for each row of aliens data
